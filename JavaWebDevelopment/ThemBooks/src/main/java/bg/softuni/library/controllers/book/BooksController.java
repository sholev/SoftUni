package bg.softuni.library.controllers.book;
...
public class BooksController {
	...
	public String getBooks(Model model, @ModelAttribute("Book") BookSearch book) {
	...
	public String addBook(Model model, @ModelAttribute("Book") Book book) {
		...
		return this.getBooks(model, new BookSearch());
	}
