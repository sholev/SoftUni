package bg.softuni.library.controllers.client;
...
public class ClientsController {
	...
	public String getClients(Model model, @ModelAttribute("Client") Client client) {
	...
	public String addClient(Model model, @ModelAttribute("Client") Client client) {
		...
		return this.getClients(model, new Client());
	}
