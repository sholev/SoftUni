namespace Assertions
{
    ...
    public static class Assertions
    {
        ...
        {
            // http://stackoverflow.com/a/1940284
            bool isOrdered = arr.Zip(arr.Skip(1), (a, b) => new { a, b })
                .All(p => p.a.CompareTo(p.b) == -1);
        ...
        {
            Debug.Assert(arr != null && arr.Length > 0, "Ivalid array.");
            Debug.Assert(IsOrdered(arr), "Using binary search on unordered array.");
        ...
        private static void SelectionSort<T>(T[] arr) where T : IComparable<T>
        {
            ...
            Debug.Assert(IsOrdered(arr), "SelectionSort failed.");
        }
